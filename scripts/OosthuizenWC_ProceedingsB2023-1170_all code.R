...
covar = soi.ses %>%
  ...
  dplyr::summarise(SOI = mean(SOI, na.rm=TRUE))
...
popN = data.frame(year = 1986:2019,
                  N = c(641, 557, 597, 540, 477, 467, 449, 454, 402,
                        428, 407, 404, 416, 410, 408, 424, 426, 464, 460,
                        433, 449, 485, 491, 511, 491, 490, 490, 518,
                        527, 516, 515, 580, 643, 697))
...
names(covar)[names(covar) == 'Year'] <- 'year'
